...
int main(int argc, char *argv[]) {
    ...
    QCommandLineOption optDiscovery("discovery", "发现缺陷记录表的文件路径\t(默认值为: discoveryRecord.bin).", "discoveryFile",
                                    "discoveryRecord.bin");
    QCommandLineOption optInspection("inspection", "探伤记录表的文件路径\t(默认值为: inspectionRecord.bin)).", "inspectionFile",
                                     "inspectionRecord.bin");
    QCommandLineOption optDaily("daily", "日常性能检查记录表的文件路径\t(默认值为: dailyRecord.bin).", "dailyFile", "dailyRecord.bin");
    QCommandLineOption optQuarterly("quarterlyRecord", "季度性能检查记录表的文件路径\t(默认值为: quarterlyRecord.bin)", "quarterlyFile",
                                    "quarterlyRecord.bin");
